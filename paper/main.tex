...
Inspired by this division of labor, we introduce \cb{}, a complete cerebellar cognitive architecture that gives AI agents a ``body''---the ability to learn skills, execute them autonomously, and perform continuous real-time control.
...
Our work suggests that the century-old insight from Marr, Albus, and Ito---that the cerebellum is a pattern-learning machine---has a natural home in modern AI systems, not as a replacement for large models, but as a fast, adaptive complement that enables the transition from ``answering machines'' to ``experienced actors.''
